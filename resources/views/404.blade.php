...
<div class="section no-pad-bot" id="index-banner">
    <div class="container">
        ...
        <div class="hide-on-small-only">
            ...
            <img class="responsive-img banner-desk-and-tablet" src="imagens/aulas%20de%20coreano%20no%20Brasil.png" width="70%" height="auto">

            <br><br><br><br><br><br><br>

            <h2 class="header center titulo-pagina sombra-texto animated pulse delay-1s faster">Hmm... <br> tente novamente<br></h2>
        ...
        <div class="show-on-small hide-on-med-and-up center-align banner-mobile-only-wordpress animated pulse delay-1s faster">
            ...
            <h2 class="header center titulo-pagina sombra-texto center-align">Hmm... <br> tente novamente<br></h2>
...
<script>
    ...
    /*function validaSelect()
     ...
     if (x == null && x = null)
     {
     alert("Preencha o select");
     }
     else{
     console.log("select não está nulo");
     }
     }
     }*/
</script>
