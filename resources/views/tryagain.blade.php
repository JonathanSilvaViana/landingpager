...
<div class="section no-pad-bot" id="index-banner">
    <div class="container">
        ...
        <div class="hide-on-small-only div-sucesso">
            ...
            <img class="responsive-img banner-desk-and-tablet center-block" src="{{ asset('/img/tryagain_site.png') }}" width="60%" height="15%">

            <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>

            <h1 class="header center titulo-pagina sombra-texto animated pulse delay-1s faster">Ops! <br> tente novamente<br></h1>

        </div>

        <div class="show-on-small hide-on-med-and-up center-align banner-mobile-only-wordpress-tryagain animated pulse delay-1s faster div-tryagain">

            <br><br><br>

            <h1 class="header center titulo-pagina sombra-texto center-align "><br>Tente <br>&nbsp;novamente <br></h1>
